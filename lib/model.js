    ...
    return Promise.try(() => {
      ...
      // Assign an auto-generated name to indexes which are not named by the user
        ...
        indexes = _.filter(this.options.indexes, item1 =>
          !_.some(indexes, item2 => item1.name.toUpperCase() === item2.name.toUpperCase())
        ).sort((index1, index2) => {
    ...
    return Promise.map(options.include, include => {
      if (!include.separate) {
        return Model._findSeparate(
          ...
          _.assign(
            {},
            _.omit(options, 'include', 'attributes', 'order', 'where', 'limit', 'offset', 'plain', 'scope', 'group'),
      ...
      return include.association.get(results, _.assign(
        {},
        _.omit(options, 'include', 'attributes', 'order', 'where', 'limit', 'offset', 'plain', 'group'),
